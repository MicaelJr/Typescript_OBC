...
const spaceshipCrewLimit = Number(prompt("Digite o Limite de tripulantes da Nave:"));
...
function MenuOptionAddMember() {
    ...
    const spaceshipName = String(prompt(`Para qual nave o ${member} de ser adicionado`));
